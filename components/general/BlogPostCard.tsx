...
export default function BlogPostCard({data}:IpropsPage){
    return(
        ...
        <div className="relative h-48 w-full overflow-hidden">
            ...
            <Image src={data.imageUrl} alt="image from db" fill  
            className="object-cover transition-transform duration-300 group-hover:scale-105"
            />
        </div>
        <div className="p-4">
            <h1 className="mb-2 text-xl font-semibold text-gray-900">{data.title}</h1>
